...
DIR_vardict <- file.path("/groups/wyattgrp/users/amunzur/pipeline/results/variant_calling/Vardict/reformatted")
DIR_ANNOVAR <- file.path("/groups/wyattgrp/users/amunzur/pipeline/results/data/annovar_outputs/vardict")
...
PATH_SAVE_chip_variants <- file.path("/groups/wyattgrp/users/amunzur/pipeline/results/variant_calling/Vardict/finalized/chip_variants.csv")
