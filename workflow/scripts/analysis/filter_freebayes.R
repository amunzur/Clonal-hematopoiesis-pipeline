...
PATH_utilities_file_freebayes <- "/groups/wyattgrp/users/amunzur/pipeline/workflow/scripts/analysis/UTILITIES_filter_freebayes.R"
PATH_utilities_file <- "/groups/wyattgrp/users/amunzur/pipeline/workflow/scripts/analysis/UTILITIES.R"
source(PATH_utilities_file_freebayes) 
...
vars <- parse_anno_output(DIR_variant_tables_chip, "chip", PATH_sample_list = PATH_sample_list)
...
vars <- parse_anno_output(DIR_variant_tables_somatic, "somatic", PATH_sample_list = PATH_sample_list)
