...
somatic_DIR_curated_muts = "/groups/wyattgrp/users/amunzur/pipeline/results/figures/IGV_snapshots/somatic_0.5"
somatic_muts_to_exclude = os.path.join(DIR_working, "resources/validated_variants/bladder_kidney_somatic_to_exclude_IGV_0.5.csv")
...
# chip_PATH_muts = f"/groups/wyattgrp/users/amunzur/pipeline/results/variant_calling/chip_WBC_only.csv"
# chip_DIR_curated_muts = "/groups/wyattgrp/users/amunzur/pipeline/results/figures/IGV_snapshots/wbc_only_chip/"
# chip_muts_to_exclude = os.path.join(DIR_working, "resources/validated_variants/chip_to_exclude_IGV_wbc_only.csv")
# chip_muts_to_keep = os.path.join(DIR_working, "results/variant_calling/chip_SSCS2_curated_wbc_only.csv")
...
def curate(PATH_muts, DIR_curated_muts, path_to_keep, path_to_exclude, PATH_sample_information, mut_type): 
...
curate(PATH_muts = chip_PATH_muts, DIR_curated_muts = chip_DIR_curated_muts, path_to_keep = chip_muts_to_keep, path_to_exclude = chip_muts_to_exclude, PATH_sample_information = PATH_sample_information, mut_type = "chip")
curate(PATH_muts = somatic_PATH_muts, DIR_curated_muts = somatic_DIR_curated_muts, path_to_keep = somatic_muts_to_keep, path_to_exclude = somatic_muts_to_exclude, PATH_sample_information = PATH_sample_information, mut_type = "ctDNA")

# def drop_misc_samples(df, path_depth):
#     """
#     Dropping additional patients and mutations for a variety of reasons
#     """
