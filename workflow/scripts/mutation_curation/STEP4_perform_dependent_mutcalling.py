...
chip_output = os.path.join(DIR_working, "results/variant_calling/chip_unadjusted_vaf.csv")
...
somatic_output = os.path.join(DIR_working, "results/variant_calling/somatic_unadjusted_vaf.csv")
...
# get_dependent_mut_calls(missing_samples_df, DIR_mpileup_SSCS2, dir_filtered_pileups, run_grep = True) # if you need to run grep run it like this.
