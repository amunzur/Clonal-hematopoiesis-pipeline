...
conda activate /home/amunzur/anaconda3/envs/pysam_env;
printf "Marrying tumor and normal at $(date +"%D %H:%M")\n";
tumor=${tmp_dir}/tumor_tmp.vstat;
normal=${tmp_dir}/normal_tmp.vstat;
python /groups/wyattgrp/users/amunzur/gene_panel_pipeline/scripts/marry_tumor_normal_vstats.py -t ${tumor} -n ${normal} -o ${tmp_dir}/${sample_tumor}_tmp_tumnormal.tsv;
conda deactivate;
