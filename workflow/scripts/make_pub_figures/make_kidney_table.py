...
PATH_kidney_clin = 'https://docs.google.com/spreadsheets/d/159Mc8UFEhv-tVFFXfP_radRsCw0z1EqMzVVGAmpKbSw/gviz/tq?tqx=out:csv&sheet=RCC_clinical_data'

# Kidney 
kidney = pd.read_csv(PATH_kidney_clin)
