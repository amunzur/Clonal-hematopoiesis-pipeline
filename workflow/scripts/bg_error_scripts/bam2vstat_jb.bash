...
outputdir="/groups/wyattgrp/users/amunzur/therapy_chip/resources/bg_error"
...
bam_list="/groups/wyattgrp/users/jbacon/projects/DDR_WBC_v2/sequencer_check/NovaSeq.txt"
